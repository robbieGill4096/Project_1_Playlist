...
public class PlayList {
	//===================
		...
		//these are the string values that prompt the user when averaging the playtimes of the songs
		private static String promptAverage = "Average play time: ";
		//Prompts user which song is closest to 4 minutes. 
		private static String promptClosestPlayTime ="Song with play time closest to 240 secs is: ";
	...
	public static String averagePlayTime(Song song0,Song song1, Song song2) {
		...
		System.out.println(fmt.format(averagePlayTime));
